...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('exibe mensagem de erro ao submeter o formulario com email com formatação invalida', function() {
    cy.clock()
  ...
  Cypress._.times(3, function() {
    it('campo telefone continua vazio quando preenchido com valir não-numérico', function() {
      cy.get('#phone')
        .type('abcdefghij')
        .should('have.value', '')
    })
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    cy.get('#lastName')
      ...
      .should('have.value', '')
    cy.get('#email')
      .type('patrick.teste@teste.com')
      .should('have.value', 'patrick.teste@teste.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('1234567890')
